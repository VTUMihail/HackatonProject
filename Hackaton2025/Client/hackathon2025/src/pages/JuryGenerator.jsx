...
export function JuryGenerator() {
  ...
  return (
    <div className="bg-linear-to-br from-indigo-100 via-blue-50 to-purple-100 flex items-center justify-center p-6">
      <div className="max-w-6xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden">
        <div className="p-8 bg-linear-to-r from-indigo-600 to-purple-600 text-white flex items-center justify-between">
...
export function JuryHistory() {
  ...
  return (
    <div className="bg-linear-to-br from-purple-100 via-indigo-50 to-blue-100 min-h-screen flex items-center justify-center p-6">
      <div className="max-w-7xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden">
        <div className="p-8 bg-linear-to-r from-purple-600 to-indigo-600 text-white flex items-center justify-between">
          <div className="flex items-center space-x-4">
